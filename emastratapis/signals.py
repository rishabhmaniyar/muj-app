...
def getAlertCandle(df15):
    ...
    # Buy Alert
    if (highBuy < emaBuy5) & (closeBuy < emaBuy5):
    ...
    def process(self):
        ...
        while not stop_event.is_set():
            ...
            while True:
                ...
                order = orders()
                if signal[0] == "BUY":
                    if pos == "NA" or pos == "SHORT":
                        print("Strikes Are -> ", strikes)
                        print("Positions flag -> ", pos)
                        # Buy Call Option
